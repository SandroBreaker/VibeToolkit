...
' Modo HUD (WPF): Abre PowerShell de forma oculta (0)
WshShell.Run powerShellExe & " -NoProfile -ExecutionPolicy Bypass -File """ & scriptDir & "\project-bundler-hud.ps1"" -Path """ & targetPath & """", 0, False
